...
class InvalidCommandSequence(DefinedExecutionError):
    def __init__(self, message: Optional[str] = None):
        ...
        super().__init__(
            LabwareTransferSiteURControllerFeature.defined_execution_errors["InvalidCommandSequence"], message=message
        )
...
class LabwareNotPicked(DefinedExecutionError):
    def __init__(self, message: Optional[str] = None):
        ...
        super().__init__(
            LabwareTransferSiteURControllerFeature.defined_execution_errors["LabwareNotPicked"], message=message
        )
...
class LabwareNotPlaced(DefinedExecutionError):
    def __init__(self, message: Optional[str] = None):
        ...
        super().__init__(
            LabwareTransferSiteURControllerFeature.defined_execution_errors["LabwareNotPlaced"], message=message
        )
