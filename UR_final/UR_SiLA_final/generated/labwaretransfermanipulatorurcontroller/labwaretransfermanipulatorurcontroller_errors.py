...
class LabwareNotPicked(DefinedExecutionError):
    def __init__(self, message: Optional[str] = None):
        ...
        super().__init__(
            LabwareTransferManipulatorURControllerFeature.defined_execution_errors["LabwareNotPicked"], message=message
        )
...
class LabwareNotPlaced(DefinedExecutionError):
    def __init__(self, message: Optional[str] = None):
        ...
        super().__init__(
            LabwareTransferManipulatorURControllerFeature.defined_execution_errors["LabwareNotPlaced"], message=message
        )
